import { addDecimals, removeDecimals } from './add-remove-decimals-bigint';
...
describe('addDecimals and removeDecimals', () => {
  it('should add decimals and remove them again ', () => {
    ...
    validCases.forEach((expected, input) => {
      // TODO: implement so it works with JavaScript bigint
      //       expect(addDecimals(input, decimals)).toStrictEqual(
      //         new BigNumber(expected)
      //       );
      //       expect(removeDecimals(expected, decimals)).toStrictEqual(
